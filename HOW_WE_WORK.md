...
| Channel | Purpose |
|---------|---------|
| `#welcome-start-here` | First landing point, pinned links to all documents |
| `#announcements` | Important updates (low-traffic, read-only for non-admins) |
| `#general` | Main discussion channel |
| `#introductions` | New members post a brief intro |
| `#project-discussion` | Technical and research work discussion |
| `#contributions` | Contribution logging and recognition |
